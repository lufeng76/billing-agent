...
2.1 For each individual customer table query within the UNION ALL structure or without, add a WHERE clause to filter on the _PARTITIONTIME pseudo-column.
